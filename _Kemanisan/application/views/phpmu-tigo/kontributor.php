...
<div class="main-page left"  style='border-radius:10px; overflow: hidden; box-shadow: 0 0 20px rgba(0,0,0,.2);'>
	<div class="single-block">
		<div class="content-block main left">
			<div class="block">
				<div class="block-title" style="background: #bf4b37;">
					<a href="<?php echo base_url(); ?>" class="right">Back to homepage</a>
					<h2>Pendaftaran untuk Penulis Berita</h2>
				</div>
					...
					<div class="shortcode-content">
							<div class="column12">
								...
								<form action="<?php echo base_url(); ?>kontributor/pendaftaran" method="POST" enctype='multipart/form-data' onSubmit="return validasireg(this)">
									...
									<p><br><input type="submit" style='border-radius:20px; box-shadow: 0 0 20px rgba(0,0,0,.2);' class="styled-button" name='submit' value="Daftar Sekarang!" /></p>
									<hr>
								</form>
								</div>
							</div>
