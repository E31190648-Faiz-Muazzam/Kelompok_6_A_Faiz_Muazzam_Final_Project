...
<div class="widget" style='border-radius:10px; overflow: hidden; box-shadow: 0 0 20px rgba(0,0,0,.2);'>
	...
	<div class="widget-social" style="padding: 10px">
		...
		<p>Ikuti kami di facebook, twitter, Google+ dan dapatkan informasi terbaru dari kami disana.</p>
	</div>
</div>

<div class="widget" style='border-radius:10px; overflow: hidden; box-shadow: 0 0 20px rgba(0,0,0,.2);'>
	<h3>Berita Terbaru</h3>
	<div class="widget-articles" style="padding: 10px">
		<ul>
			<li>
				<?php 
...
<div class="widget" style='border-radius:10px; overflow: hidden; box-shadow: 0 0 20px rgba(0,0,0,.2);'>
	...
	<div class="widget-comments" style="padding: 10px;">
		<ul>
			<?php
...
<div class="widget" style='border-radius:10px; overflow: hidden; box-shadow: 0 0 20px rgba(0,0,0,.2);'>
	<h3>Video Terbaru</h3>
	<div class="latest-galleries" style="padding: 10px;">
		<?php						  
