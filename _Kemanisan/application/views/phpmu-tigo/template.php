...
<div id='Back-to-top'>
  <img alt='Back to top' src='<?php echo base_url(); ?>asset/images/top.png'/>
		...
		<div class="boxed">	
			...
			<div class="content">
				<div class="wrapper" style="padding: 30px; box-shadow: 0 0 10px rgba(0,0,0,.3); border-radius: 20px;">	
				<?php 
					...
					if ($this->uri->segment(1)=='' OR $this->uri->segment(1)=='main'){
						echo "<div class='breaking-news'>
							<span class='the-title' style='background: radial-gradient(circle at top left, #325236, #3c6c3c);'>HOT News</span>
							<ul>";
