<div class='panel-body'>
    ...
    <div id='myTabContent' class='tab-content'>
            ...
            <div class="block-content">
                <div id="writecomment">
                    <form action="<?php echo base_url(); ?>auth/register" method="POST" id="form_komentar">
                        ...
                        <p><input type="submit" name="submit1" class="styled-button" style="border-radius: 10px; background-color: #5cb85c; box-shadow: 0 0 5px rgba(0,0,0,0.3); margin-top: 20px;" value="Daftar Sebagai Pembeli"/></p>
                    </form>
                </div>
            </div>
        ...
        <div class='alert alert-warning'><b>PENTING!</b> Lengkapi Form dibawah ini untuk mendaftarkan diri sebagai <b>Agen-Kemanisan</b>, harap di isi dengan data yang sebenar-benarnya, Terima kasih...</div>
            <div class="block-content">
                <div id="writecomment">
                    <form action="<?php echo base_url(); ?>auth/register" method="POST" id="form_komentar">
                        <p class="contact-form-user">
                        ...
                        <p><input type="submit" name="submit2" class="styled-button" style="border-radius: 10px; background-color: #5cb85c; box-shadow: 0 0 5px rgba(0,0,0,0.3); margin-top: 20px;" value="Daftar Sebagai Agen"/></p>
                    </form>
                </div>
            </div>
            <div style='clear:both'><br></div>
