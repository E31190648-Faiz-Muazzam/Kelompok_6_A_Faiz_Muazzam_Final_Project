        ...
        <div class='col-md-9' style='padding:0px'>
            ...
            echo "<table class='table table-condensed' style='margin-bottom:0px'>
                ...
                if (($beli['beli']-$jual['jual'])>=1){
                    echo "<tr><td style='font-weight:bold'>Tersedia</td> <td class='text-success'>".($beli['beli']-$jual['jual'])." Kg</td></tr>";
                }else{
                    echo "<tr><td style='font-weight:bold'>Stok</td> <td>Tidak Tersedia</td></tr>";
                }

            echo "<tr><td style='font-weight:bold'>Beli /Kg</td> <td><input type='number' value='1' name='qty'></td></tr>
            </table>
