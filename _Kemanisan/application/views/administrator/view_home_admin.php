  ...
  <div class="col-md-3 col-sm-6 col-xs-12">
    <div class="info-box" style='box-shadow: 0 0 10px rgba(0,0,0,.3); border-radius: 10px; overflow: hidden;'>
...
<section class="col-lg-7 connectedSortable">
  ...
  ?>
  <div class='box' style='box-shadow: 0 0 10px rgba(0,0,0,.3); border-radius: 10px; overflow: hidden;'>
