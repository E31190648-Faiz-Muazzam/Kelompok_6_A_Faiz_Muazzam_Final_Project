...
<html>
  ...
  <body class="hold-transition login-page" style="background: radial-gradient(circle at top left, #fdbb2d, #22c1c3);">
    <div class="login-box">
      <div class="login-logo">
        <a href="#"><b>ADMIN</b> Login</a>
      </div><!-- /.login-logo -->
      <div class="login-box-body" style='box-shadow: 0 0 10px rgba(0,0,0,.3); border-radius: 10px; overflow: hidden;'>
        ...
        ?>
          <div class="form-group has-feedback">
            <input type="text" class="form-control" style="border-radius: 10px;" name='a' placeholder="Username" required>
            <span class="glyphicon glyphicon-user form-control-feedback"></span>
          </div>
          <div class="form-group has-feedback">
            <input type="password" class="form-control" style="border-radius: 10px;" name='b' placeholder="Password" required>
          ...
          <div class="form-group has-feedback">
            <input type="text" class="form-control" style="border-radius: 10px; " name='security_code' placeholder="Security Code" required>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-xs-4">
              <input name='submit' type="submit" class="btn btn-success btn-block btn-flat" style="border-radius: 10px;" value='Sign In'>
            </div><!-- /.col -->
          </div>
        </form>
        <hr>
