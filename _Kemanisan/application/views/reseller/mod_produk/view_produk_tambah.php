    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <td>
                    <select name='a' class='form-control' onchange=\"showSub()\" required>
                    ...
                    <option value='' selected>- Pilih Sub Kategori Produk -</option></td></tr>
                    ...
                    <tr><th scope='row'>Stok Awal / Kg</th>                 
                    ...
                    <td><input type='file' id='fileupload' class='form-control' name='userfile[]' multiple>Multiple Upload, Allowed File : .gif, jpg, png
